...
Your first Savant workflow is created, executed, and scheduled. You can now use the workflow to automate recurring data preparation, analysis, and reporting tasks.`,A0=`---
...
- [Fuse Agent](/savant-kb/docs/fuse-agent)
- [S3 connector](/savant-kb/docs/s3-connector)
`,L0=Object.assign({"./docs/adp-connector.md":u0,"./docs/agents-overview.md":c0,"./docs/connectors-overview.md":f0,"./docs/excel-files.md":d0,"./docs/financial-reconciliation.md":h0,"./docs/functions-reference.md":m0,"./docs/fuse-agent.md":p0,"./docs/google-sheets.md":g0,"./docs/governance-audit-trail.md":y0,"./docs/infer-agent.md":v0,"./docs/keyboard-shortcuts.md":S0,"./docs/match-agent.md":b0,"./docs/quickstart.md":w0,"./docs/royalties-commissions.md":A0,"./docs/s3-connector.md":E0,"./docs/sales-tax.md":T0,"./docs/signup.md":_0,"./docs/snowflake-connector.md":R0,"./docs/templates-overview.md":C0,"./docs/transform-agent.md":x0,"./docs/vision-agent.md":O0,"./docs/welcome.md":M0,"./docs/workflows-overview.md":D0,"./docs/workspace-setup.md":k0,"./docs/your-first-workflow.md":z0});function N0(i){const s=/^---\r?\n([\s\S]*?)\r?\n---\r?\n?([\s\S]*)$/.exec(i);if(!s)return{fm:{title:"Untitled",collection:"Misc",description:"",order:999,updated:""},body:i};const[,l,u]=s,c={};for(const d of l.split(/\r?\n/)){const m=/^([a-zA-Z_][\w-]*)\s*:\s*(.*)$/.exec(d);if(!m)continue;const[,y,p]=m;try{c[y]=JSON.parse(p)}catch{c[y]=p.replace(/^["']|["']$/g,"")}}return{fm:c,body:u}}const sc=Object.entries(L0).map(([i,s])=>{const l=i.replace(/^\.\/docs\//,"").replace(/\.md$/,""),{fm:u,body:c}=N0(s);return{slug:l,fm:u,body:c}}).sort((i,s)=>i.fm.order-s.fm.order),U0={"Getting Started":{description:"Set up your workspace, build your first workflow, and get the right people invited.",icon:"Rocket",order:1},"Platform Concepts":{description:"Workflows, agents, and the governance model that makes Savant audit-ready by default.",icon:"Layers",order:2},Agents:{description:"AI-powered nodes for inference, transformation, matching, and document extraction.",icon:"Sparkles",order:3},"Connectors & Files":{description:"Read and write data across 70+ databases, warehouses, SaaS apps, and file systems.",icon:"Plug",order:4},"Templates & Solutions":{description:"Opinionated, production-ready workflows for finance, ops, and revenue teams.",icon:"LayoutTemplate",order:5},Reference:{description:"Function reference, keyboard shortcuts, and API access.",icon:"BookOpen",order:6}},B0=Object.entries(U0).map(([i,s])=>({name:i,slug:i.toLowerCase().replace(/[^a-z0-9]+/g,"-"),description:s.description,icon:s.icon,docs:sc.filter(l=>l.fm.collection===i).sort((l,u)=>l.fm.order-u.fm.order),_order:s.order})).sort((i,s)=>i._order-s._order).map(({_order:i,...s})=>s),tw=sc;function H0(i){return sc.find(s=>s.slug===i)}const Xs=B0.flatMap(i=>i.docs);function nw(i){const s=Xs.findIndex(l=>l.slug===i);return s===-1?{}:{prev:s>0?Xs[s-1]:void 0,next:s<Xs.length-1?Xs[s+1]:void 0}}const j0=()=>Eo(()=>import("./docs._slug-C2_L5Nav.js"),__vite__mapDeps([8,3,2,6])),q0=()=>Eo(()=>import("./docs._slug-CRONSE-I.js"),[]),G0=rl("/docs/$slug")({loader:({params:i})=>{const s=H0(i.slug);if(!s)throw qv();return s},head:({loaderData:i})=>{if(!i)return{};const{fm:s}=i,l=`${s.title} — Savant Docs`;return{meta:[{title:l},{name:"description",content:s.description},{property:"og:title",content:l},{property:"og:description",content:s.description},{name:"twitter:title",content:l},{name:"twitter:description",content:s.description}]}},notFoundComponent:So(q0,"notFoundComponent"),component:So(j0,"component")}),lc=i0.update({id:"/docs",path:"/docs",getParentRoute:()=>oc}),Y0=s0.update({id:"/",path:"/",getParentRoute:()=>oc}),Q0=r0.update({id:"/",path:"/",getParentRoute:()=>lc}),P0=G0.update({id:"/$slug",path:"/$slug",getParentRoute:()=>lc}),V0={DocsSlugRoute:P0,DocsIndexRoute:Q0},I0=lc._addFileChildren(V0),X0={IndexRoute:Y0,DocsRoute:I0},K0=oc._addFileChildren(X0)._addFileTypes(),Bp=new Fb,Hp="/savant-kb/".replace(/\/$/,"")||"/",F0=new URLSearchParams(window.location.search),$m=F0.get("redirect");$m&&window.history.replaceState(null,"",`${Hp}${$m}`);const Z0=db({routeTree:K0,basepath:Hp,context:{queryClient:Bp},scrollRestoration:!0,defaultPreloadStaleTime:0}),J0=document.getElementById("root");mv.createRoot(J0).render(V.jsx(Sa.StrictMode,{children:V.jsx(Jb,{client:Bp,children:V.jsx(pb,{router:Z0})})}));export{ll as L,Op as O,W0 as R,$0 as a,G0 as b,B0 as c,tw as d,nw as e,ee as f,Zu as g,pa as h,ot as i,V as j,Fe as k,Rp as r,Tp as u};
